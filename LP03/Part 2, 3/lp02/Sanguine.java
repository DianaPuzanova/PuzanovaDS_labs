...
public class Sanguine extends Person
{

	public Sanguine(int mood)
	{
		super(mood);
	}
	...
	public Message say(Message answer) {
		...
		if (answer.getText().equals("Hello")) {
			...
			mess.putData("Basked in the sun:)", 1);
			return mess;
    ...
    {
        return super.Equals(other) && this.GetSerializationPrefix().equals(other.GetSerializationPrefix());
    }
}